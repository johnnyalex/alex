<?php 
include'../init.php';
$sql="SELECT id,name,pid,path,CONCAT(path,id,',') bpath FROM ".PRE."category ORDER BY bpath";
//echo $sql;exit;
...
?>    
    <option value="<?php echo $value['id'] ?>" ><?php echo $space.$value['name']?></option>
<?php }?>
</select>
        </td>
      </tr>
      ...
      <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
        ...
        <td align="left" valign="middle" class="borderright borderbottom main-for">
        <input type="text" name="stock" class="text-word">
        </td>
      </tr>
      <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
