...
$id=$_GET['id'];
//var_dump($id);
$sql="SELECT id,name,sex,type,display FROM ".PRE."user WHERE id={$id}";
  ...
  <tr>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" id="main-tab">
      ...
      <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
        ...
        <label><input type="radio" name="sex" value="0" <?php echo $row['sex']==0?'checked':'' ?>>女</label>
        <label><input type="radio" name="sex" value="1" <?php echo $row['sex']==1?'checked':'' ?>>男</label>
        <label><input type="radio" name="sex" value="2" <?php echo $row['sex']==2?'checked':'' ?>>保密</label>
        </td>
      </tr>
      <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
	    ...
	    <option value="1" <?php echo $row['type']==1?'selected':'' ?>>&nbsp;&nbsp;一般管理员</option>
