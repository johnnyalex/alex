...
<table width="99%" border="0" cellspacing="0" cellpadding="0" id="main">
  <tr>
    ...
    <span class="time"><strong>上午好！<?php echo @$_SESSION['admin']['name'] ?></strong><u>[<?php $type=$_SESSION['admin']['type'];switch($type){case 0:echo '普通用户';break;case 1:echo '普通管理员';break;case 2:echo '超级管理员';break;} ?>]</u></span>
    <div class="top"><span class="left">您上次的登录时间：<?php echo date('Y-m-d H:i:s',time()) ?> 登录IP: <?php echo $_SERVER['SERVER_ADDR'] ?>&nbsp;&nbsp;&nbsp;&nbsp;如非您本人操作，请及时</span><a href="index.html" target="mainFrame" onFocus="this.blur()">更改密码</a></div>
...
MYSQL版本：<?php echo @mysqli_get_server_info($link) ?><br/>
魔术引用：开启 (建议开启)<br/>
